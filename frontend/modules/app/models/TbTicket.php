 ...
 * @property int $ticket_status สถานะการใช้งาน
 */
class TbTicket extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['hos_name_th', 'template', 'barcode_type', 'ticket_status'], 'required'],
    ...
    {
        return [
            'ticket_ids' => Yii::t('frontend', 'Ticket Ids'),
            'hos_name_th' => Yii::t('frontend', 'Hos Name Th'),
            'hos_name_en' => Yii::t('frontend', 'Hos Name En'),
            'template' => Yii::t('frontend', 'Template'),
            'default_template' => Yii::t('frontend', 'Default Template'),
            'logo_path' => Yii::t('frontend', 'Logo Path'),
            'logo_base_url' => Yii::t('frontend', 'Logo Base Url'),
            'barcode_type' => Yii::t('frontend', 'Barcode Type'),
            'ticket_status' => Yii::t('frontend', 'Ticket Status'),
        ];
    }
                ...
                <div class="row" style="width: 80mm;margin: auto;">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12" style="padding: 0px 21px 0px 21px;">
                        <div class="col-xs-12" style="padding: 0;text-align:center;">
                            <h5 style="text-align: center;"><b style="font-weight: 600;">{service_name}</b></h5>
                        </div>
                    </div>
            ...
            <div class="x_content">
                <div class="row" style="width: 80mm;margin: auto;">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12" style="padding: 1cm 21px 0px 21px;">
                        ...
                        <div class="col-xs-12" style="padding: 0;">
                            <h4 class="color" style="margin-top: 0px;margin-bottom: 0px;text-align: center;"><b style="font-weight: bold;">โรงพยาบาลเทศบาลอุดรธานี</b></h4>
                            <h6 class="color" style="margin-top: 4px;margin-bottom: 0px;text-align: center;"><b>งานบริการผู้ป่วยนอก</b></h6>
                        </div>
                        <div class="col-xs-12" style="padding: 3px 0px 10px 0px;;text-align: left;">
                            <h6 style="margin: 4px 1px;" class="color">
                            ...
                            <h6 style="margin: 4px 1px;" class="color">
                                <b style="font-size: 14px; font-weight: 600;">ชื่อ-นามสกุล</b>  :  <b style="font-size: 13px;">Udon Thani Hospital</b>
                            </h6>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12" style="padding: 0px 21px 0px 21px;">
                        ...
                        <div class="col-xs-6" style="padding: 0;text-align: right;">
                            <h6 class="color" style="margin-top: 4px;margin-bottom: 0px;text-align: right;"><b>Admin</b></h6>
                        </div>
                    </div>
    ...
    public function getTicketPreview()
    {
        ...
        return strtr($this->template, [
            ...
            '/imgs/udh-logo.png' => $this->logo_path ? $this->logo_base_url . '/' . $this->logo_path : '/imgs/udh-logo.png',
        ]);
    }
}
