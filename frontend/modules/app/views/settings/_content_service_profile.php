...
<div class="panel-body">
    <?php
    echo Table::widget([
        'tableOptions' => ['class' => 'table table-hover', 'id' => 'tb-service-profile'],
        'beforeHeader' => [
            [
                'columns' => [
                    ['content' => '#', 'options' => ['style' => 'text-align: center;width: 35px;']],
                    ['content' => Yii::t('frontend', 'Service Profile Name'), 'options' => ['style' => 'text-align: center;']],
                    ...
                    ['content' => Yii::t('frontend', 'Service Profile Status'), 'options' => ['style' => 'text-align: center;']],
        ...
        'datatableOptions' => [
            "clientOptions" => [
                ...
                "language" => [
                    ...
                    "lengthMenu" => "_MENU_",
                    "sSearch" => "ค้นหา: _INPUT_ ".Html::a(Icon::show('plus').' '.Yii::t('frontend','Add'),['/app/settings/create-service-profile'],['role' => 'modal-remote','class' => 'btn btn-success'])
                ],
                "pageLength" => 10,
                "columns" => [
