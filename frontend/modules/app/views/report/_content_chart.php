...
<div class="panel-body">
    <p>
        <?= Html::tag('span','Notice! คิวที่ไม่ได้จ่าย หมายถึง คิวที่ยังไม่ได้ถูกเรียก, ',['class' => 'label label-warning']) ?> &nbsp;
        <?= Html::tag('span','Notice! คิวที่ค้างจ่าย หมายถึง คิวที่เรียกไปแล้วแต่ไม่เสร็จสิ้น, ',['class' => 'label label-warning']) ?> &nbsp;
        <?= Html::tag('span','Notice! คิวที่จ่ายได้ หมายถึง คิวที่เสร็จสิ้น, ',['class' => 'label label-warning']) ?> &nbsp;
    </p>
    <div class="row content-count<?= $service_group_id ?>">
        <?php foreach ($model['services'] as $service) : ?>
            <div class="col-md-3">
                <div class="hpanel <?= $service['bg'] ?>">
                    <div class="panel-body">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 border-right border-bottom border-left border-top">
            ...
            echo Highcharts::widget([
                ...
                'options' => [
                    ...
                    'series' => $model['dataChart3']['series'],
                    'legend' => ['enabled' => false],
                    'drilldown' => $model['dataChart3']['drilldown'],
                    'credits' => ['enabled' => false],
                ],
                'scripts' => [
                    'highcharts-more',   // enables supplementary chart types (gauge, arearange, columnrange, etc.)
