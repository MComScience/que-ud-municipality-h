...
<?= GridView::widget([
    ...
    //'layout'       => "{items}\n{pager}",
    'panel' => [
        'heading' => \homer\widgets\Icon::show('users').' '.$this->title,
        'type' => 'default',
        'before' => Html::a('<i class="glyphicon glyphicon-plus"></i> '.Yii::t('user', 'New user'), ['create'], ['class' => 'btn btn-success','data-pjax' => 0]),
        'after' => Html::a('<i class="glyphicon glyphicon-repeat"></i> Reset Grid', ['index'], ['class' => 'btn btn-default']),
        'footer' => ''
    ],
    'columns' => [
        /*[
